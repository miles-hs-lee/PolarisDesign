...
const CARDS = [
  ...
  },
  {
    ...
    icon: Layers,
    title: '컴포넌트 카탈로그',
    desc: '30개 컴포넌트(Tier 0 + Tier 1 + Tier 2 + Tier 2.5)의 모든 variant·상태·조합을 한 페이지에서 확인',
    badge: '레퍼런스',
    accent: 'primary' as const,
  },
] as const;
        ...
        <Card>
          <CardBody>
            ...
            <ul className="text-polaris-body-sm text-fg-secondary space-y-2">
              <li>
                <code className="text-fg-primary font-polaris-mono">@polaris/ui</code> — 토큰 + 30개 컴포넌트
              </li>
              <li>
