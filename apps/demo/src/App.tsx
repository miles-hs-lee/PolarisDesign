      ...
      <div className="min-h-screen bg-surface-canvas text-text-primary font-polaris">
        <div className="max-w-6xl mx-auto px-6 py-10">
          <header className="flex items-center justify-between mb-8 pb-4 border-b border-surface-border">
            <div>
              <h1 className="text-polaris-heading-lg">
                Polaris UI <Badge variant="secondary">Tier 0</Badge>
              </h1>
              <p className="text-polaris-body-sm text-text-muted mt-1">
                12 components rendered with @polaris/ui tokens · 라이트/다크 토글로 페어 검증
              </p>
            </div>
          ...
          <footer className="mt-12 pt-6 border-t border-surface-border text-polaris-caption text-text-muted text-center">
            Polaris UI v0.0.1 · {Object.keys({Button:1,Input:1,Textarea:1,Card:1,Badge:1,Avatar:1,Dialog:1,Toast:1,Tabs:1,FileIcon:1,FileCard:1,NovaInput:1}).length} components rendered
          </footer>
        </div>
